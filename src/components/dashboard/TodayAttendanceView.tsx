    ...
    <div id="today-attendance-view" className="space-y-6 animate-in fade-in duration-200">
        ...
        <div className="flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-xl p-1.5 self-start md:self-auto">
          ...
          {selectedDate !== '2026-09-14' && (
            <button
              ...
              className="text-[11px] font-semibold text-indigo-600 hover:text-indigo-800 px-2 py-1 bg-indigo-50 rounded-md"
            >
              Back to Today
            </button>
          )}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
        ...
        >
          ...
          <div className="text-2xl font-black font-mono tracking-tight">{totalExpected}</div>
          <p className="text-[11px] opacity-70 mt-1">Total scheduled</p>
        </button>
        ...
        >
          ...
          <div className="text-2xl font-black font-mono tracking-tight text-emerald-600 dark:text-white">
            {presentNow}
          </div>
        ...
        >
          <div className="flex items-center justify-between text-xs font-semibold mb-2 text-blue-600">
            <span className={statusFilter === 'completed' ? 'text-blue-100' : 'text-blue-700 font-bold'}>
              Completed
            </span>
            <CheckCircle2 className="w-4 h-4" />
          </div>
          <div className="text-2xl font-black font-mono tracking-tight text-blue-600 dark:text-white">
            {completedToday}
          </div>
          <p className="text-[11px] text-slate-500 opacity-80 mt-1">Departed with record</p>
        </button>
        ...
        >
          ...
          <div className="text-2xl font-black font-mono tracking-tight text-slate-700 dark:text-white">
            {notArrivedYet}
          </div>
        ...
        >
          <div className="flex items-center justify-between text-xs font-semibold mb-2 text-amber-600">
            <span className={statusFilter === 'attention' ? 'text-amber-100' : 'text-amber-700 font-bold'}>
              Needs Attention
            </span>
            <AlertTriangle className="w-4 h-4" />
          </div>
          <div className="text-2xl font-black font-mono tracking-tight text-amber-600 dark:text-white">
            {attentionCount}
          </div>
